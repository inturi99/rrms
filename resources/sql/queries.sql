...
UPDATE documents set documentname = :documentname,title = :title,employeename = :employeename,date = CURRENT_DATE,location = :location,updateddatetime = now()  where id = :id
RETURNING id,documentname,title,employeename,date,location,barcode,isactive
